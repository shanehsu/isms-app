...
export class SingleLineTextFormControl {
  // 推送資料
...
const CUSTOM_VALUE_ACCESSOR = CONST_EXPR(new Provider(
  NG_VALUE_ACCESSOR, {useExisting: forwardRef(() => SingleLineTextFormControlValueAccessor), multi: true}
))
...
export class SingleLineTextFormControlValueAccessor implements ControlValueAccessor {
  private _onChanged = (_) => {}
  private _onTouched = () => {}

  constructor(private _host: SingleLineTextFormControl) {
