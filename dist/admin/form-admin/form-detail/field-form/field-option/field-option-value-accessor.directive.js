...
// 控制的元件
var field_option_component_1 = require('./field-option.component');
var CUSTOM_VALUE_ACCESSOR = {
    provide: common_1.NG_VALUE_ACCESSOR,
    useExisting: core_1.forwardRef(function () { return FieldOptionValueAccessor; }),
    multi: true
};
var FieldOptionValueAccessor = (function () {
    ...
    FieldOptionValueAccessor = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof field_option_component_1.FieldOptionComponent !== 'undefined' && field_option_component_1.FieldOptionComponent) === 'function' && _a) || Object])
    ], FieldOptionValueAccessor);
    return FieldOptionValueAccessor;
    var _a;
}());
exports.FieldOptionValueAccessor = FieldOptionValueAccessor;
